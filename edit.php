...
<body>
        ...
        <form class="container" action="update.php?ID=<?php echo $UserID ?>" method="post">
                ...
                <div class="card">
                 ...
                 <div class="card-body">
                    <div class="form-group">
                      ...
                      <input type="text" name="email" id="email" class="form-control" value="<?php echo $UserEmail?>" required>
                    </div>
                </div>
                 ...
                 <div class="card-body">
                    <div class="form-group">
                      ...
                      <input type="text" name="age" id="age" class="form-control" value="<?php echo $UserAge?>" required>
                    </div>
                </div>
